...
<div id="page">
	...
	if ( have_posts() ) : the_post();?>		
		...
		<?php if ( isset( $_REQUEST['projectid'] ) ) : ?>
			<span class="pagesubtitle-h4"><?php echo _e( 'Project Updates For', 'Rotary' );?></span><br>
		...
		<?php elseif ( isset( $_REQUEST['committeeid'] ) ) : ?>
			<span class="pagesubtitle-h4"><?php echo _e( 'Committee Updates For', 'Rotary' );?></span><br>
		...
		<?php elseif ( is_day() ) : ?>
				<span class="pagesubtitle-h4"><?php echo _e( 'Daily Archive', 'Rotary' );?></span><br>
				<span class="pagesubtitle-h1"><?php echo get_the_date(); ?></span>
		<?php elseif ( is_month() ) : ?>
			<?php if (is_post_type_archive( 'rotary_speakers' )) : ?>
				<span class="pagesubtitle-h4"><?php echo _e( 'Monthly Archive', 'Rotary' );?></span><br>
		...
		<?php elseif ( is_year() ) : ?>
			<?php if ( is_post_type_archive( 'rotary_speakers' )) : ?>			
				<span class="pagesubtitle-h4"><?php echo _e( 'Annual Archive', 'Rotary' );?></span><br>
		...
		<?php elseif ( is_post_type_archive( 'post' )) : ?>
				...
				<span class="pagesubtitle-h1"><?php echo get_the_date('Y'); ?></span>
		<?php else: ?>
				<span class="pagesubtitle-h4"><?php echo _e( 'Archive', 'Rotary' );?></span><br>
				<span class="pagesubtitle-h1"><?php echo _e( 'All Posts and Updates', 'Rotary' ); ?></span>
		<?php endif; ?>
		</h2>
