...
function rotary_boardmembers_html( $atts ) {
	...
	<div class="boardmembers-container">
		...
		<h1><?php echo  rotary_club_header($clubname, $rotaryClubBefore ) . __( ' Board Members' );?></h1>
		<?php 
		if( !empty( $boardmembers->results ) ) :
			...
			?>
				<div class="bbrc-member-container" width="75">
					<div style="background-image: url( <?php echo get_avatar_url( $boardmember->ID, array( 'size' => 'full' ));?> );" class="bbrc-picture-container"></div>
